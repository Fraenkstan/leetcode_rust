...
mod tests {
    ...
    use crate::topic_796::rotate_string;
    ...
    fn solution_782() {
        ...
        println!(
            "{}",
            moves_to_chessboard(vec![vec![1, 1, 0], vec![0, 0, 1], vec![0, 0, 1]])
        );
    }
    ...
    #[test]
    fn solution_796() {
        println!("{}", rotate_string("abcde".to_string(), "cdeab".to_string()));
        println!("{}", rotate_string("abcde".to_string(), "abced".to_string()));
    }
