...
mod tests {
    ...
    #[test]
    fn solution_01_02() {
        println!("{}", check_permutation("abc".to_string(), "bca".to_string()));
        println!("{}", check_permutation("abc".to_string(), "bad".to_string()));
    }
    ...
    fn solution_01_05() {
        ...
        println!("{}", one_edit_away("teacher".to_string(), "treacher".to_string()));
    }
    ...
    fn solution_01_07() {
        ...
        rotate(&mut test1);
        println!("{:?}", test1);
        let mut test2 = vec![vec![5,1,9,11], vec![2,4,8,10], vec![13,3,6,7], vec![15,14,12,16]];
        rotate(&mut test2);
        println!("{:?}", test2);
    }
    ...
    #[test]
    fn solution_01_09() {
        println!("{}", is_fliped_string("waterbottle".to_string(), "erbottlewat".to_string()));
